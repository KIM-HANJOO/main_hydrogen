...
class Info() :
    def __init__(self, main_module_dir) :
        ...
        self.prep_dir = os.path.join(main_dir, '1_preprocessing')
        self.model_dir = os.path.join(main_dir, '2_model')
        self.module_dir = os.path.join(main_dir, 'module')
        self.facility_dir = os.path.join(main_dir, 'FACILITIES')
        self.plot_dir = os.path.join(main_dir, 'plot')
        self.cluster_dir = os.path.join(main_dir, '0_temp_dir(clustering)')
        self.nfc_dir = os.path.join(main_dir, 'FACILITIES')
        self.gp_dir = os.path.join(main_dir, 'GENERATED_PROFILES')
        self.gp_plot = os.path.join(main_dir, 'GENERATED_PLOTS')
        self.params = os.path.join(self.gp_dir, 'params')
