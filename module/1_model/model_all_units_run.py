...
for facility in os.listdir(gp_dir) :
	if facility != '판매및숙박' :
		...
		for group in range(2) :
			...
			plot_dir = main_dir + '\\GENERATED_PLOTS'
			...
			print('\nmodel_4 running')
			mu.model_4(model3dir, model4_dir)
			
			print('\nmodel_1 plotting')
			mu.model1_plot(model1_dir, plot_dir)
			print('\nmodel_2 plotting')
			mu.model2_plot(model2_dir, plot_dir)
			print('\nmodel_3 plotting')
			mu.model3_plot(facility, model3_dir, plot_dir)
			print('\nmodel_4 plotting')
			mu.model4_plot(facility, model4_dir, plot_dir)
