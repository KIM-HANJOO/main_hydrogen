...
gp_dir = os.path.join(accom_deal_profile_48, 'GENERATED_PROFILES')
gp_plot = os.path.join(accom_deal_profile_48, 'GENERATED_PLOTS')
...
'''
import model_all_units_accom_deal as mu

facility_list = ['판매시설'] #'판매시설' 
...
#
                if check == 1 :
                    ...
                    print('\nmodel_1 compare')
                    mu.model1_compare(facility, group, model1_dir, nplot_dir, facility_dir)
#                print('\nmodel_2_all')
#                mu.model2_all(facility, model2_dir, plot_dir, facility_dir)
                    print('\nmodel_2 compare')
                    mu.model2_compare(facility, group, model2_dir, nplot_dir, facility_dir)
                    print('\nmodel_3 compare')
                    mu.model3_compare(facility, group, model3_dir, nplot_dir, facility_dir)
                    print('\nmodel_4 compare')
                    mu.model4_compare(facility, group, model4_dir, nplot_dir, facility_dir)
